...
def populate():
    python_pages = [
        ...
        {"title": "How to Think Like a Computer Scientist", "url": "http://wwww.greenteapress.com/thinkpython/", "views": 16},
        {"title": "Learn Python in 10 Minutes", "url": "http://www.korokithakis.net/tutorials/python/", "views": 8},]

    django_pages = [
        {"title": "Official Django Tutorial", "url": "https://doc.djangoproject.com/en/1.9/intro/tutorial01", "views": 32},
        {"title": "Django Rocks", "url": "http://www.djangorocks.con/", "views": 16},
